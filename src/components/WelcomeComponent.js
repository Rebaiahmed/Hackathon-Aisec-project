...
<b />
 ...
 <button className="button button2" onClick={this.props.DispMonument}>Esele aLes Monuments</button>
 <button className="button button2" onClick={this.props.DispResto}>Esel a les restuarants</button>
